// Note: deploy procedure
// 1. Edit and save this file in Unity Editor so it is compiled
// 2. Click "Show Generated Code" in the Inspector
// 3. Copy the generated code to the file "TransparentMeshShader.shader"
// 4. Rename the generated shader to "Custom/TransparentBrain"
// 5. Change "ColorMask RGB" to "ColorMask RGBA" in the generated code

Shader "Custom/TransparentBrainUncompiled"
{
	Properties
	{
