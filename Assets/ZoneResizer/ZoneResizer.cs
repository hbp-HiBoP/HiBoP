    ...
    void SetCursor()
    {
        switch(Direction)
        {
            case DirectionType.BottomToTop:
                cursor = Resources.Load("Cursor/ns") as Texture2D;
                hotSpot = new Vector2(20, 50);

                break;

            case DirectionType.LeftToRight: cursor = Resources.Load("Cursor/ew") as Texture2D;
                hotSpot = new Vector2(50, 20);
                break;
        }
    }
    void Start()
