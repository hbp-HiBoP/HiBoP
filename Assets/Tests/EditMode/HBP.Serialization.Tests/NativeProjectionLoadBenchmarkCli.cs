    ...
    public static class NativeProjectionLoadBenchmarkCli
    {
        ...
        public static void Run()
        {
            ...
            try
            {
                ...
                string volumePath = OptionalArgument(arguments, VolumeArgument)
                    ?? Path.Combine(Application.dataPath, "Data", "IRM", "MNI.nii");
                ...
                foreach (NativeProjectionLoadScenarioDefinition scenario in scenarios)
                {
                    ...
                    NativeProjectionLoadScenarioResult result = NativeProjectionLoadBenchmarkScenarios.Run(
                        scenario,
                        surfacePath,
                        volumePath,
                        exportRoot,
