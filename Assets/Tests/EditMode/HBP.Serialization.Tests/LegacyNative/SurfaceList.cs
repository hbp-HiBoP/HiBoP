...
namespace HBP.Tests.Serialization.LegacyNative
{
    ...
    public class SurfaceList : CppDLLImportBase
    {
        ...
        public Surface TakeSurface(int index)
        {
            ...
            return new Surface(surface, BenchmarkBackend.HbpCore);
        }
        ...
        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_surface_list_destroy", CallingConvention = CallingConvention.Cdecl)]
        private static extern HbpCoreStatus hbp_surface_list_destroy(IntPtr surfaces);

        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_surface_list_get_count", CallingConvention = CallingConvention.Cdecl)]
        private static extern HbpCoreStatus hbp_surface_list_get_count(IntPtr surfaces, out int count);

        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_surface_list_take_surface", CallingConvention = CallingConvention.Cdecl)]
