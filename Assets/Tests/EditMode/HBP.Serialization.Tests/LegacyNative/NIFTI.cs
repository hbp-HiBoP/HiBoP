...
namespace HBP.Tests.Serialization.LegacyNative
{
    public class NIFTI : CppDLLImportBase
    {
        ...
        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_nifti_create", CallingConvention = CallingConvention.Cdecl)]
        static private extern HbpCoreStatus hbp_nifti_create(out IntPtr nifti);

        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_nifti_destroy", CallingConvention = CallingConvention.Cdecl)]
        static private extern HbpCoreStatus hbp_nifti_destroy(IntPtr nifti);

        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_nifti_load", CallingConvention = CallingConvention.Cdecl)]
        static private extern HbpCoreStatus hbp_nifti_load(IntPtr nifti, [MarshalAs(UnmanagedType.LPUTF8Str)] string path);

        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_nifti_convert_to_volume", CallingConvention = CallingConvention.Cdecl)]
        static private extern HbpCoreStatus hbp_nifti_convert_to_volume(IntPtr nifti, IntPtr volume, int t);

        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_nifti_get_number_of_volumes", CallingConvention = CallingConvention.Cdecl)]
        static private extern HbpCoreStatus hbp_nifti_get_number_of_volumes(IntPtr nifti, out int count);

        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_nifti_get_extrema", CallingConvention = CallingConvention.Cdecl)]
        static private extern HbpCoreStatus hbp_nifti_get_extrema(IntPtr nifti, out VolumeExtrema extrema);

        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_nifti_get_start_time", CallingConvention = CallingConvention.Cdecl)]
        static private extern HbpCoreStatus hbp_nifti_get_start_time(IntPtr nifti, out float startTime);

        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_nifti_get_time_step", CallingConvention = CallingConvention.Cdecl)]
        static private extern HbpCoreStatus hbp_nifti_get_time_step(IntPtr nifti, out float timeStep);

        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_nifti_get_time_unit", CallingConvention = CallingConvention.Cdecl)]
        static private extern HbpCoreStatus hbp_nifti_get_time_unit(IntPtr nifti, out IntPtr timeUnit);

        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_nifti_copy_histogram_bins", CallingConvention = CallingConvention.Cdecl)]
