...
namespace HBP.Tests.Serialization.LegacyNative
{
    public class DensityGenerator : ActivityGenerator
    {
        ...
        [DllImport(LegacyNativeLibrary.HbpExport, EntryPoint = "create_DensityGenerator", CallingConvention = CallingConvention.Cdecl)]
        static private extern IntPtr create_DensityGenerator();

        [DllImport(LegacyNativeLibrary.HbpExport, EntryPoint = "delete_DensityGenerator", CallingConvention = CallingConvention.Cdecl)]
        static private extern void delete_DensityGenerator(HandleRef generator);

        [DllImport(LegacyNativeLibrary.HbpExport, EntryPoint = "compute_activity_DensityGenerator", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(LegacyNativeLibrary.HbpExport, EntryPoint = "max_density_DensityGenerator", CallingConvention = CallingConvention.Cdecl)]
        static private extern float max_density_DensityGenerator(HandleRef generator);

        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_density_generator_create", CallingConvention = CallingConvention.Cdecl)]
        static private extern HbpCoreStatus hbp_density_generator_create(out IntPtr generator);

        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_density_generator_destroy", CallingConvention = CallingConvention.Cdecl)]
        static private extern HbpCoreStatus hbp_density_generator_destroy(IntPtr generator);

        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_density_generator_compute_activity_from_sites", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(LegacyNativeLibrary.HbpCore, EntryPoint = "hbp_density_generator_get_max_density", CallingConvention = CallingConvention.Cdecl)]
