...
namespace HBP.Tests.Serialization
{
    public class CoreDataSerializationTests
    {
            ...
            try
            {
                ...
                UserPreferences userPreferences = new(
                    new GeneralPreferences(
                        new UserProjectPreferences("default-project-alpha", temp.GetPath("projects"), temp.GetPath("exports")),
                    ...
                    new VisualizationPreferences(
                        new _3DPreferences(false, true, LayoutDirection.Horizontal, SiteInfluenceByDistanceType.Linear, "MRI-alpha", "Mesh-alpha", "Implantation-alpha", "MNI-alpha", "MNI-mesh-alpha", "MNI-implantation-alpha"),
                        new TrialMatrixPreferences(false, false, false, 5, false, BlocFormatType.TrialHeight, 12, 0.01f, 0.2f, 1.1f),
                        new GraphPreferences(false, false, 3, 9, 2),
                        new CutPreferences(false)),
                    "user-preferences-alpha");
        ...
        {
            VisualizationConfiguration configuration = ClassLoaderSaver.LoadFromJsonString<VisualizationConfiguration>(
                "{\"ID\":\"legacy-visualization-config-minimal\",\"Mesh\":\"legacy-mesh-alpha\"}");
            ...
            UserPreferences userPreferences = ClassLoaderSaver.LoadFromJsonString<UserPreferences>(
                "{\"ID\":\"legacy-user-preferences-minimal\",\"General\":{\"System\":{\"MultiThreading\":false}}}");
        ...
        {
            DataProjectPreferences projectPreferences = ClassLoaderSaver.LoadFromJsonString<DataProjectPreferences>(
                "{\"ID\":\"legacy-project-preferences-unknown\",\"Version\":\"0.1.0\",\"CanLoadProject\":false,\"ObsoleteDatabasePath\":\"ignored\"}");
            VisualizationConfiguration configuration = ClassLoaderSaver.LoadFromJsonString<VisualizationConfiguration>(
                "{\"ID\":\"legacy-visualization-config-unknown\",\"Brain Alpha\":0.45,\"OldCutMode\":\"ignored\",\"RemovedToolbarState\":{\"Value\":true}}");
        ...
        {
            TagCollection sourceTags = new(
                new BaseTag[] { new StringTag("general-alpha", "source-tag-general-alpha") },
                new BaseTag[] { new BoolTag("patient-alpha", "source-tag-patient-alpha") },
                new BaseTag[] { new EnumTag("site-alpha", new[] { "one", "two" }, "source-tag-site-alpha") },
                "source-tag-collection");
            TagCollection targetTags = new(
                new BaseTag[] { new StringTag("old-general", "target-tag-general-old") },
                new BaseTag[0],
                new BaseTag[0],
