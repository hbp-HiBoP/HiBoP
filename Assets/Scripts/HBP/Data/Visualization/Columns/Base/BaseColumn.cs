...
namespace HBP.Data.Visualization
{
    ...
    */
    [DataContract]
    public abstract class BaseColumn : ICloneable
    {
        #region Properties
        /// <summary>
        /// Name of the column.
        ...
        public BaseColumn(string name, BaseConfiguration baseConfiguration)
        {
            Name = name;
        ...
        /// </summary>
        public BaseColumn():this("New column", new BaseConfiguration())
        {
        }
        #endregion
