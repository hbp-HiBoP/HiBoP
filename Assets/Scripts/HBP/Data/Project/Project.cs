...
namespace HBP.Data
{
    ...
    */
    public class Project
    {
        ...
        public bool CheckIDUnicity(BaseData data)
        {
            if (data is Patient || data is Site)
            {
                foreach (var baseData in data.GetAllIdentifiable())
                {
                    foreach (var projectObject in m_Patients.SelectMany(p => p.GetAllIdentifiable()))
                    {
                        if (baseData.ID == projectObject.ID)
                        {
                            return false;
                        }
                    }
            ...
            else if (data is Group)
            {
                foreach (var baseData in data.GetAllIdentifiable())
                {
                    foreach (var projectObject in m_Groups.SelectMany(p => p.GetAllIdentifiable()))
                    {
                        if (baseData.ID == projectObject.ID)
                        {
                            return false;
            ...
            else if (data is Protocol)
            {
                foreach (var baseData in data.GetAllIdentifiable())
                {
                    foreach (var projectObject in m_Protocols.SelectMany(p => p.GetAllIdentifiable()))
                    {
                        if (baseData.ID == projectObject.ID)
                        {
                            return false;
            ...
            else if (data is Dataset)
            {
                foreach (var baseData in data.GetAllIdentifiable())
                {
                    foreach (var projectObject in m_Datasets.SelectMany(p => p.GetAllIdentifiable()))
                    {
                        if (baseData.ID == projectObject.ID)
                        {
                            return false;
            ...
            else if (data is Visualization.Visualization)
            {
                foreach (var baseData in data.GetAllIdentifiable())
                {
                    foreach (var projectObject in m_Visualizations.SelectMany(p => p.GetAllIdentifiable()))
                    {
                        if (baseData.ID == projectObject.ID)
                        {
                            return false;
            ...
            else if (data is BaseTag)
            {
                foreach (var baseData in data.GetAllIdentifiable())
                {
                    foreach (var projectObject in Preferences.GetAllIdentifiable())
                    {
                        if (baseData.ID == projectObject.ID)
                        {
                            return false;
