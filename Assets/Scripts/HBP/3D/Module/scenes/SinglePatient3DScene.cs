...
namespace HBP.Module3D
{
    ...
    public class SinglePatient3DScene : Base3DScene
    {
        ...
        ///// </summary>
        //public void UndefineCurrentSource(bool all = false)
        //{
        ...
        ///// </summary>
        ///// <param name="id"></param>
        //public void UpdateCurrentLatencyFile(int id, bool all = false)
        //{
        //    if (m_ColumnManager.SelectedColumn.Type == Column3D.ColumnType.IEEG)
        //    {
        //        if (all)
