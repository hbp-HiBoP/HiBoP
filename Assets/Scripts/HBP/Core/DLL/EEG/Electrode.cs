...
namespace HBP.Core.DLL.EEG
{
    public class Electrode : CppDLLImportBase
    {
        ...
        {
            get { return GetElectrodePhysicalMinimum(_handle); }
        }
        ...
        {
            get { return GetElectrodePhysicalMaximum(_handle); }
        }
        ...
        {
            get { return GetElectrodeDigitalMinimum(_handle); }
        }
        ...
        {
            get { return GetElectrodeDigitalMaximum(_handle); }
        }
        ...
        {
            get { return GetElectrodeDigitalGround(_handle); }
        }
        ...
        {
            get { return GetElectrodePrefilteringHighPassLimit(_handle); }
        }
        ...
        {
            get { return GetElectrodePrefilteringLowPassLimit(_handle); }
        }
        ...
        public int Type
        {
            get { return GetElectrodeType(_handle); }
        }
