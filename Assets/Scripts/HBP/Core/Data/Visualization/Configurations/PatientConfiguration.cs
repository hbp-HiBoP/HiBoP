...
namespace HBP.Core.Data
{
    ...
    */
    ...
    public class PatientConfiguration : ICloneable
    {
        ...
        [JsonProperty("Patient")] string m_PatientID;
        Patient m_Patient;
        [JsonIgnore] public Patient Patient => m_Patient;

        [JsonProperty("ConfigurationByElectrode")] Dictionary<string, ElectrodeConfiguration> m_ConfigurationByElectrodeName;

        /// <summary>
        /// Configuration of the patient electrodes.
        /// </summary>
        [JsonIgnore] public Dictionary<string, ElectrodeConfiguration> ConfigurationByElectrode { get; set; }
        ...
        {
            m_Patient = context.ResolveRequired(context.PatientById, m_PatientID ?? m_Patient?.ID, "patient", nameof(PatientConfiguration));
        }
        ...
        void OnDeserialized(StreamingContext streamingContext)
        {
            ...
            ConfigurationByElectrode = m_ConfigurationByElectrodeName ?? new Dictionary<string, ElectrodeConfiguration>();
        }
