...
namespace HBP.Core.Data
{
    ...
    public class MEGcDataInfo : PatientDataInfo
    {
        ...
        public MEGcDataInfo(string name, Protocol protocol, Container.DataContainer dataContainer, Patient patient, string correspondingDatabaseID, string ID) : base(name, protocol, dataContainer, patient, correspondingDatabaseID, ID)
        {
        }
        /// <summary>
        /// Create a new CCEPDataInfo instance.
        ...
        /// <param name="patient">Patient related to the data.</param>
        /// <param name="channel">Stimulated channel.</param>
        public MEGcDataInfo(string name, Protocol protocol, Container.DataContainer dataContainer, Patient patient, string correspondingDatabaseID) : base(name, protocol, dataContainer, patient, correspondingDatabaseID)
        {
        }
        /// <summary>
        /// Create a new CCEPDataInfo instance.
        /// </summary>
        public MEGcDataInfo() : this("Data", DatabaseManager.Database.Protocols.FirstOrDefault(), new Container.Elan(), null, "")
        {
        ...
        {
            return new MEGcDataInfo(Name, Protocol, DataContainer.Clone() as Container.DataContainer, Patient, CorrespondingDatabaseID, ID);
        }
