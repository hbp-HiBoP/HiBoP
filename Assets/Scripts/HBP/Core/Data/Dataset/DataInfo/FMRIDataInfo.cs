...
namespace HBP.Core.Data
{
    ...
    public class FMRIDataInfo : PatientDataInfo
    {
        ...
        public FMRIDataInfo(string name, Protocol protocol, Container.DataContainer dataContainer, Patient patient, string correspondingDatabaseID, string ID) : base(name, protocol, dataContainer, patient, correspondingDatabaseID, ID)
        {
        }
        /// <summary>
        /// Create a new CCEPDataInfo instance.
        ...
        /// <param name="patient">Patient related to the data.</param>
        /// <param name="channel">Stimulated channel.</param>
        public FMRIDataInfo(string name, Protocol protocol, Container.DataContainer dataContainer, Patient patient, string correspondingDatabaseID) : base(name, protocol, dataContainer, patient, correspondingDatabaseID)
        {
        }
        /// <summary>
        /// Create a new CCEPDataInfo instance.
        /// </summary>
        public FMRIDataInfo() : this("Data", DatabaseManager.Database.Protocols.FirstOrDefault(), new Container.Elan(), null, "")
        {
        ...
        {
            return new FMRIDataInfo(Name, Protocol, DataContainer.Clone() as Container.DataContainer, Patient, CorrespondingDatabaseID, ID);
        }
