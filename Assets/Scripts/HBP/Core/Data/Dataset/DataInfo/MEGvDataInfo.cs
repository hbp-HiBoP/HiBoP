...
namespace HBP.Core.Data
{
    ...
    public class MEGvDataInfo : PatientDataInfo
    {
        ...
        /// Create a new CCEPDataInfo instance.
        /// </summary>
        public MEGvDataInfo() : this("Data", null, new Container.Nifti(), new Container.Nifti(), new Error[0], new Warning[0], null, "")
        {
        ...
        internal override void ApplyValidationState(DataInfo validatedSnapshot)
        {
            ...
            m_MaskDataContainer.ApplyValidationState(
                ((MEGvDataInfo)validatedSnapshot).m_MaskDataContainer);
        }
        #endregion
