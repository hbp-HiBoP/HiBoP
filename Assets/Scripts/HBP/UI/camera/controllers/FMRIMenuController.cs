...
namespace HBP.VISU3D
{
    ...
    public class FMRIMenu : MonoBehaviour
    {
        ...
        {
            DLL.Texture.generate_distribution_histogram(m_scene.CM.DLLVolumeFMriList[m_columnId], 4 * 110, 4 * 110, m_calMin, m_calMax).update_texture_2D(m_IRMFhistogram);
    ...
    public class FMRIMenuController : MonoBehaviour, UICameraOverlay
    {
        ...
        {
            int nbIEEGCols = m_scene.CM.IEEG_columns_nb();
