...
namespace HBP.UI.Informations.TrialMatrix
{
    public class Bloc : MonoBehaviour
    {
        ...
        {
            get { return ChannelBlocs.Any(channelBloc => channelBloc.Hovered); }
        }
        ...
        {
            get { return ChannelBlocs.FirstOrDefault(c => c.Hovered); }
        }
        ...
        {
            get { return new ReadOnlyCollection<ChannelBloc>(m_ChannelBlocs); }
        }
