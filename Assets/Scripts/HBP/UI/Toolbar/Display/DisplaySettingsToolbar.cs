...
namespace HBP.UI.Toolbar
{
    public class DisplaySettingsToolbar : Toolbar
    {
        ...
        protected override void AddListeners()
        {
            ...
            m_Views.OnClick.AddListener(() => { Module3DMain.OnRequestUpdateInToolbar.Invoke(); });

            m_StandardViews.OnClick.AddListener(() => { Module3DMain.OnRequestUpdateInToolbar.Invoke(); });
        }
