...
namespace HBP.UI.Toolbar
{
    public class ToolbarMenu : MonoBehaviour
    {
        ...
        {
            get { return m_ConfigurationToolbar; }
            set { m_ConfigurationToolbar = value; }
        }
        ...
        {
            get { return m_SceneSettingsToolbar; }
            set { m_SceneSettingsToolbar = value; }
        }
        ...
        {
            get { return m_DisplaySettingsToolbar; }
            set { m_DisplaySettingsToolbar = value; }
        }
        ...
        {
            get { return m_ActivitySettingsToolbar; }
            set { m_ActivitySettingsToolbar = value; }
        }
        ...
        {
            get { return m_TimelineToolbar; }
            set { m_TimelineToolbar = value; }
        }
        ...
        {
            get { return m_SiteToolbar; }
            set { m_SiteToolbar = value; }
        }
        ...
        {
            get { return m_AtlasToolbar; }
            set { m_AtlasToolbar = value; }
        }
        ...
        {
            get { return m_ROIToolbar; }
            set { m_ROIToolbar = value; }
        }
        ...
        {
            get { return m_TriangleToolbar; }
            set { m_TriangleToolbar = value; }
        }
        ...
        {
            Module3DMain.OnRequestUpdateInToolbar.AddListener(() => { m_UpdateRequired = true; });
            Module3DMain.OnFinishedAddingNewScenes.AddListener(() => { CurrentToolbar.ShowToolbarCallback(); });
