...
namespace HBP.UI.Informations
{
    public class ROIInformations : MonoBehaviour
    {
        ...
        //    void DisplayGraphs(SceneROIStruct ROI)
        //    {
        ...
        //        Dictionary<DataStruct, Dictionary<Bloc, Dictionary<SubBloc, Graph.Curve>>> ROICurvesByData = new Dictionary<DataStruct, Dictionary<Bloc, Dictionary<SubBloc, Graph.Curve>>>();
        ...
        //                foreach (var subBloc in bloc.Bloc.SubBlocs)
        //                {
        //                    //Graph.Curve curve = new Graph.Curve("ROI")
        //                }
        //            }
        //        }
        ...
        //        {
        //            DisplayChannelGraphs(channelStruct, ROI, subBlocsAndWindowByColumn);
        //        }
        //    }
        //    void DisplayChannelGraphs(ChannelStruct channelStruct, SceneROIStruct ROI, Tuple<SubBloc[], Tools.CSharp.Window>[] subBlocsAndWindowByColumn)
        //    {
        ...
        //        }
        //    }
        //    Tuple<Graph.Curve[], Tools.CSharp.Window, bool>[] GenerateDataCurve(ChannelStruct channelStruct, SceneROIStruct ROI, Tuple<SubBloc[], Tools.CSharp.Window>[] subBlocsAndWindowByColumn)
        //    {
        ...
        //            IEnumerable<DataStruct> data = ROI.ChannelsByData.Where(p => p.Value.Contains(channelStruct)).Select(p => p.Key);
        ...
        //        return result;
        //    }
        //    Graph.Curve GenerateROICurve(DataStruct data, ROIStruct ROI, Bloc bloc, SubBloc subBloc, string id)
        //    {
        //        id = id + "_" + ROI.Name;
