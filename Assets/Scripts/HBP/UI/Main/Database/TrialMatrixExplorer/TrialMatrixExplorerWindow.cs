...
namespace HBP.UI.Database
{
    public class TrialMatrixExplorerWindow : DialogWindow
    {
        ...
        {
            m_Patients = DatabaseManager.Database.Patients.Where(p => DatabaseManager.Database.DataInfos.OfType<IEEGDataInfo>().Any(d => d.Patient == p)).ToList();
            ...
            m_PatientDropdown.value = index != -1 ? index : 0;
        }
        protected void SetDataNames()
        {
            ...
            m_DataDropdown.value = index != -1 ? index : 0;
        }
        ...
        protected void DisplayTrialMatrices()
        {
            ...
            {
                m_TrialMatrixDisplayer.Display(m_SelectedPatient, m_SelectedDataName);
            }
        }
        #endregion
    }
