...
namespace HBP.UI.Main
{
    public class SiteTagFilterConditionSubModifier : SubModifier<SiteTagFilterCondition>
    {
        ...
        protected override void SetFields(SiteTagFilterCondition objectToDisplay)
        {
            ...
            m_TargetDropdown.Set(typeof(SiteTagFilterCondition.TargetType), (int)objectToDisplay.Target);
        ...
        void OnChangeTarget(int value)
        {
            ...
            {
                SiteTagFilterCondition.TargetType.Site => PersistentDataManager.Tags.SitesTags.Concat(PersistentDataManager.Tags.GeneralTags).ToList(),
                SiteTagFilterCondition.TargetType.Patient => PersistentDataManager.Tags.PatientsTags.Concat(PersistentDataManager.Tags.GeneralTags).ToList(),
