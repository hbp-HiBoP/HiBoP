...
namespace HBP.UI.Main
{
    public class HelpMenu : Menu
    {
        ...
        public MenuButton OpenVersionWindowButton
        {
            get { return m_OpenVersionWindowButton; }
        }

        [SerializeField] private MenuButton m_OpenBugReporterButton;

        public MenuButton OpenBugReporterButton
        {
            get { return m_OpenBugReporterButton; }
        }

        [SerializeField] private MenuButton m_OpenAboutWindowButton;

        public MenuButton OpenAboutWindowButton
        {
            get { return m_OpenAboutWindowButton; }
        }
