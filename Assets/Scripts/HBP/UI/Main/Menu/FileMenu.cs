...
namespace HBP.UI.Main
{
    public class FileMenu : Menu
    {
        ...
        public MenuButton NewProjectButton
        {
            get { return m_NewProjectButton; }
        }

        [SerializeField] private MenuButton m_OpenProjectButton;

        public MenuButton OpenProjectButton
        {
            get { return m_OpenProjectButton; }
        }
        ...
        {
            get { return m_SaveAsButton; }
        }

        [SerializeField] private MenuButton m_QuickStartButton;

        public MenuButton QuickStartButton
        {
            get { return m_QuickStartButton; }
        }
