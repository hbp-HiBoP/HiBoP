...
namespace HBP.UI.Main
{
    public class ProjectMenu : Menu
    {
        ...
        public MenuButton OpenProjectPreferencesButton { get { return m_OpenProjectPreferencesButton; } }

        [SerializeField] private MenuButton m_OpenPatientGestionButton;
        public MenuButton OpenPatientGestionButton { get { return m_OpenPatientGestionButton; } }

        [SerializeField] private MenuButton m_OpenGroupGestionButton;
        public MenuButton OpenGroupGestionButton { get { return m_OpenGroupGestionButton; } }

        [SerializeField] private MenuButton m_OpenDatasetGestionButton;
        public MenuButton OpenDatasetGestionButton { get { return m_OpenDatasetGestionButton; } }

        [SerializeField] private MenuButton m_OpenVisualizationGestionButton;
        public MenuButton OpenVisualizationGestionButton { get { return m_OpenVisualizationGestionButton; } }
        #endregion
