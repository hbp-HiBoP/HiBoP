...
namespace HBP.UI.Module3D.Tools
{
    public class LoadPatient : Tool
    {
        ...
        public override void Initialize()
        {
            ...
            {
                ApplicationState.Module3D.LoadSinglePatientSceneFromMultiPatientScene(SelectedScene.Visualization, SelectedScene.Patients[SelectedScene.SelectedColumn.SelectedPatientID]);
            });
        }
