...
namespace HBP.UI.Module3D
{
    ...
    public class CutController : MonoBehaviour
    {
        ...
        /// </summary>
        public Tuple<CutOrientation, Texture2D>[] CutTextures
        {
            get { return (from cutParameterController in m_CutParametersControllers select new Tuple<CutOrientation, Texture2D>(cutParameterController.Cut.Orientation, cutParameterController.Texture)).ToArray(); }
        }
        ...
        {
            get { return m_CutParametersControllers.FirstOrDefault(c => c.AreControlsOpen)?.Cut; }
        }
        ...
        private void AddCut(Core.Object3D.Cut cut)
        {
            ...
            cut.OnRemoveCut.AddListener(() => { m_CutParametersControllers.Remove(controller); });
        ...
        public void Initialize(Base3DScene scene)
        {
            ...
            m_Scene.OnAddCut.AddListener((cut) => { AddCut(cut); });
