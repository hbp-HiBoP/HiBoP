...
namespace HBP.VISU3D
{
    ...
    public class ScreenMessageController : BothScenesOverlayController
    {
        ...
        public new void init(ScenesManager scenesManager)
        {
            ...
            m_spScene.display_screen_message_event.AddListener((message, duration, width, height) =>
            {
                stop(true);
            ...
            m_spScene.display_scene_progressbar_event.AddListener((duration, width, height, value) =>
            {
                stop(true, true);
            ...
            m_mpScene.display_screen_message_event.AddListener((message, duration, width, height) =>
            {
                stop(false);
            ...
            m_mpScene.display_scene_progressbar_event.AddListener((duration, width, height, value) =>
            {
                stop(false, true);
        ...
        public override void update_UI_position()
        {
            ...
            {
                Rect rectCamera = CamerasManager.screen_rectangle(m_camerasManager.screen_rectangleT(true), m_backGroundCamera);
            ...
            {
                Rect rectCamera = CamerasManager.screen_rectangle(m_camerasManager.screen_rectangleT(false), m_backGroundCamera);
