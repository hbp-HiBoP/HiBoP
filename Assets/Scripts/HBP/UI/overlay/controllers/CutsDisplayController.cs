...
namespace HBP.VISU3D
{
    public class CutsDisplayMenu : MonoBehaviour
    {
        ...
        public void update_UI_position()
        {
            for (int ii = 0; ii < m_currentPlanesNb; ++ii)
            {
                ...
                {
                    Rect rectCamera = CamerasManager.screen_rectangle(m_texturesGOContainer[ii].gameObject.GetComponent<RectTransform>(), m_backGroundCamera);
    ...
    public class CutsDisplayController : MonoBehaviour
    {
        ...
        {            
            ...
            scenesManager.SPScene.UpdateCutsInUI.AddListener((textures, idColumn, nbPlanes) =>
            {                
                m_spIsActive = true;
                m_mpIsActive = false;
            ...
            scenesManager.MPScene.UpdateCutsInUI.AddListener((textures, idColumn, nbPlanes) =>
            {
                m_spIsActive = false;
                m_mpIsActive = true;
