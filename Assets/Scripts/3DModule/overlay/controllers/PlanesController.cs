...
namespace HBP.VISU3D
{
    ...
    public class PlanesController : IndividualSceneOverlayController
    {
        ...
        public new void init(Base3DScene scene, CamerasManager camerasManager)
        {
            ...
            // choose plane
            m_ChoosePlanePanel = Instantiate(BaseGameObjects.ChoosePlanePanel);
            ...
            addPlaneButton.onClick.AddListener(delegate { if (currentPlaneNumber < maxPlaneNumber) { addAndInitPlane(); } });
        ...
        private void updatePlane(int idPlane)
        {
            ...
            m_scene.updatePlane(idOrientation, flip, removeFrontPlane, new Vector3(x, y, z), idPlane, position);
        }
        ...
        private void addPlane()
        {
            ...
            setPlanePanelList.Add(Instantiate(BaseGameObjects.SetPlanePanel));
