...
namespace HBP.VISU3D
{
    ...
    public class Mode : MonoBehaviour
    {
        ...
        public enum FunctionsId : int
        {
            ...
            updateMiddle, updateMaskPlot, addIRMFColumn, removeLastIRMFColumn, resetScene
        }; /**< scene functions id */
        ...
        public void setModeSpecifications(bool force)
        {
            ...
            m_sendModeSpecifications.Invoke(m_modeSpecs);
            m_needsUpdate = false;
        }
        ...
        public Mode.ModesId mu_resetGIIBrainSurfaceFile()
        {
            ...
            if(m_sceneSp)
            {
                ...
                {
                    if (m_sceneStates.volumeLoaded && m_sceneStates.meshesLoaded)
                    {
                        if (!m_sceneStates.electodesLoaded || !m_sceneStates.timelinesLoaded)
