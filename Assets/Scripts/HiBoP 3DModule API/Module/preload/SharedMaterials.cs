...
namespace HBP.VISU3D
{
    ...
    public class SharedMaterials : MonoBehaviour
    {
        public struct Brain
        {
            public static Material SpBrain = null;
            public static Material SpCut = null;

            public static Material MpBrain = null;
            public static Material MpCut = null;
        }
        ...
        void Awake()
        {
            ...
            // Brain
            Brain.SpBrain = Instantiate(Resources.Load("Materials/Brain/SpBrain", typeof(Material))) as Material;
            Brain.MpBrain = Instantiate(Resources.Load("Materials/Brain/MpBrain", typeof(Material))) as Material;
            Brain.SpCut = Instantiate(Resources.Load("Materials/Brain/SpCut", typeof(Material))) as Material;
            Brain.MpCut = Instantiate(Resources.Load("Materials/Brain/SpCut", typeof(Material))) as Material;
