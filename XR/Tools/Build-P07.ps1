...
$artifactRoot = Join-Path $repositoryPath ".artifacts\xr\p07"

if ([string]::IsNullOrWhiteSpace($OutputPath))
{
    $OutputPath = Join-Path $artifactRoot "HiBoPXR-P07.apk"
}
...
$arguments = @(
    ...
    "-buildTarget", "Android",
    "-executeMethod", "CRNL.HiBoP.XR.DistributedSession.Editor.P07ProjectSetup.BuildAndroid",
    "-p07BuildOutput", $OutputPath,
    "-p07BuildEvidence", (Join-Path $artifactRoot "build-evidence.json"),
