...
- `VisualizationEntity`, `ColumnEntity` et `ColumnVisualization` portent les mappings explicites nécessaires pour joindre ces IDs sans supposer qu'un `scopeId` égale un ID d'entité ;
