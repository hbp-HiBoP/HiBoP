...
| <a id="quest-015"></a>[QUEST-015](tasks/QUEST-015.md) | IMPLEMENTEE | REUSSI | NON_REQUIS | [Rapport](reports/QUEST-015.md) · [Preuves](evidence/QUEST-015/manifest.json) ; deux builds Android identiques, 226 exports, 39 contrôles updater, 9 contrôles natifs, 25 tests Unity et APK/alignement vérifiés. Artefact du run GitHub 34337066008 fourni par le propriétaire et comparé : code/données/ABI identiques, métadonnées différentes ; SHA source CI distinct du pin Desktop, pas d’installation. Logs CI privés non consultés ; runtime réservé à QUEST-016. |
